...
![Dashboard Overview](./02_logistics_dashboard.png)
...
![Star Schema](./01_star_schema_data_model.png)
...
![Обзор дашборда](./02_logistics_dashboard.png)
...
![Схема «Звезда»](./01_star_schema_data_model.png)
